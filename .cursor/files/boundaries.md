...
-Stop starting or using an Android emulator for any testing on this project, automatically or otherwise. The user has a physical Samsung S25 Ultra connected via USB with debugging enabled — use that exclusively going forward. Confirm adb devices shows it before doing anything else.